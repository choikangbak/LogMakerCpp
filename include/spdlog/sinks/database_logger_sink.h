		...
		public:
			...
			void bind_to_statement(const details::log_msg& msg) const
			{
				...
				if (sqlite3_bind_text(_query_stmt, 1, time_str, -1, SQLITE_STATIC) != SQLITE_OK ||
					sqlite3_bind_text(_query_stmt, 2, (char*)msg.level, -1, SQLITE_STATIC) != SQLITE_OK ||
					sqlite3_bind_text(_query_stmt, 3, "hello world!", -1, SQLITE_STATIC) != SQLITE_OK ||
					sqlite3_bind_text(_query_stmt, 4, "hehe", -1, SQLITE_STATIC) != SQLITE_OK ||
